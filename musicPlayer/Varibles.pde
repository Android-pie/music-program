void var() {
  ...
  BackButtonX = width * 1.9/5;

  R1SecsButtonX = width *1.3/5;

  NextButtonX = width * 3.1/5;
  ...
  ImageButtonX = width * 3/30;
  ImageButtonY = height * 3/30;
  ImageButtonWidth = width * 2/3;
  ...
  img2 = loadImage("bird2.jpg");
  img3 = loadImage("bird3.jpg");
}
